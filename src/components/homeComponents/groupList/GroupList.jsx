...
const GroupList = ({isChat=false}) => {
  ...
  */
  ...
  return (
    <div className={isChat ? 'w-full h-[200px] md:w-[100%] lg:w-[100%] lg:h-[100%] bg-[#ffffff62] shadow-md shadow-black rounded-md z-20' : 'w-full h-[200px] md:w-[49%] lg:w-[32.5%] lg:h-[49%] bg-[#ffffff62] shadow-md shadow-black rounded-md z-20'}>
