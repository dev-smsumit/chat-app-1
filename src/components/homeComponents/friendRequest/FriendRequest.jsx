    ...
    <div className='w-[32.5%] h-[49%] bg-[#ffffff62] z-20 shadow-md shadow-black rounded-md'>
        ...
        <div className='w-full h-full bg-[#0000ff17] rounded-b-md p-1' >
            ...
            <h1 className='text-lg font-bold uppercase flex'>friend requests
                    ...
                    <span class="relative flex justify-center items-center text-xs rounded-full h-6 w-6 bg-emerald-300 font-semibold">{friendRequList?.length}</span>
                    </span>
                </h1>
            ...
            <div className='h-[80%] w-full scrollbar-thin scrollbar-thumb-[#ef444485] scrollbar-track-[#0000ff62] overflow-y-scroll divide-y divide-solid divide-slate-300'>
            {
                friendRequList?.map((item)=>(
                    <div className='flex justify-between items-center py-1 ' key={item.friendRequKey}>
