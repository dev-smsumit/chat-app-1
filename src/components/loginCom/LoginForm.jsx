 ...
 */
  ...
  */
  ...
  return (
    ...
    <div className='p-4 sm:p-6 bg-[#ffffff1e] backdrop-blur-sm rounded-xl shadow-md shadow-[#00000049] w-full max-w-md mx-auto'>
      <div className='mb-6'>
        <h1 className='text-center text-2xl sm:text-3xl font-bold'>
          LET'S START <span className='font-mono bg-gradient-to-r from-customRed to-customIndigo bg-clip-text text-transparent'>ChatMate</span>
        </h1>
        <p className='text-center text-sm sm:text-md font-medium'>It's Free Forever</p>
        <h3 className='text-center text-lg sm:text-xl font-bold uppercase mt-2 mb-4'>have some nice chats!</h3>
      </div>

      <form action="#" onSubmit={(e) => e.preventDefault()}>
        <fieldset className='border border-white p-4 sm:p-5 rounded-md'>
          <legend className='text-base sm:text-lg font-semibold px-2'>Your Information</legend>
          ...
          <div className='mb-4'>
            ...
            />
            <span className='text-red-700 text-xs font-bold'>{loginInputError.emailError}</span>
          </div>
          ...
          <div className='mb-4'>
            <div className='flex justify-between items-center'>
              ...
              <span className='cursor-pointer text-indigo-800 mt-1 text-lg' onClick={handleEye}>
                {eye ? <PiEyeClosedDuotone /> : <FaRegEye />}
              </span>
            </div>
            <input
            ...
            />
            <span className='text-red-700 text-xs font-bold'>{loginInputError.passwordError}</span>
          </div>

          {/* Login Button */}
          <div>
            <button
              className='w-full flex justify-center items-center bg-gradient-to-r from-customRed to-customIndigo text-white mt-2 h-10 rounded-md text-sm font-semibold hover:opacity-90 transition-all duration-300'
